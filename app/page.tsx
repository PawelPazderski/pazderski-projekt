...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen max-w-screen-xl mx-auto px-2.5 flex-col items-center justify-start text-center text-sm md:text-base">
      <Navigation />
      <div 
        ...
        >
        <Image
          className="relative rounded-full mt-12 mb-8 md:mt-24 md:mb-16 w-32 md:w-48"
          src="/pp_jc_foto.png"
